...
# For Windows users, you may have to add (mode="wb") to the download.file call.
# For more information, the documentation is available here: https://www.rdocumentation.org/packages/utils/versions/3.6.2/topics/download.file
```
